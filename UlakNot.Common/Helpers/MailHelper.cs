    ...
    public class MailHelper
    {
        ...
        public static bool SendMail(string body, List<string> to, string subject, bool isHtml = true)
        {
            ...
            try
            {
                ...
                message.From = new MailAddress(ConfigReadHelper.Get<string>("MailUser"));
                ...
                using (var smtp = new SmtpClient(
                    ConfigReadHelper.Get<string>("MailHost"),
                    ConfigReadHelper.Get<int>("MailPort")))
                {
                    smtp.EnableSsl = true;
                    smtp.Credentials =
                        new NetworkCredential(
                            ConfigReadHelper.Get<string>("MailUser"),
                            ConfigReadHelper.Get<string>("MailPass"));
